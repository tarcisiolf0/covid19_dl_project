...
if __name__ == '__main__':
    ...
    parser.add_argument('--weightspath', default='models/COVIDNet-CXR4-C', type=str, help='Path to model files, defaults to \'models/COVIDNet-CXR4-C\'')
    # parser.add_argument('--metaname', default='model.meta', type=str, help='Name of ckpt meta file')
    parser.add_argument('--metaname', default='model.meta', type=str, help='Name of ckpt meta file')
    # parser.add_argument('--ckptname', default='model', type=str, help='Name of model ckpts')
    parser.add_argument('--ckptname', default='model-3090', type=str, help='Name of model ckpts')
