...
parser.add_argument('--weightspath', default='models/COVIDNet-lr1e-05', type=str, help='Path to model files, defaults to \'models/COVIDNet-CXR4-C\'')
# parser.add_argument('--metaname', default='model.meta', type=str, help='Name of ckpt meta file')
parser.add_argument('--metaname', default='model.meta', type=str, help='Name of ckpt meta file')
# parser.add_argument('--ckptname', default='model', type=str, help='Name of model ckpts')
parser.add_argument('--ckptname', default='model-52', type=str, help='Name of model ckpts')
...
parser.add_argument('--trainfile', default='train_metadata.txt', type=str, help='Path to train file')
# parser.add_argument('--testfile', default='labels/test_COVIDx8B.txt', type=str, help='Path to test file')
parser.add_argument('--testfile', default='test_metadata.txt', type=str, help='Path to test file')
...
parser.add_argument('--training_tensorname', default='keras_learning_phase:0', type=str, help='Name of training placeholder tensor')
